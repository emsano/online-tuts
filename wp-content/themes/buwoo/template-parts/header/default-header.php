...
<div class="head_dyna header-area2 home-v2 <?php if( $sticky_header == 1 ){ ?> header_sticky <?php } if( $tranhdr_optn == 1 ){ echo 'transparenthdr'; } if( $transparenthdr == 1 ){ echo 'pghdrtrans '; } if( $topheader == 1 ){ echo ' hdtr_tphdr'; } ?><?php if( $header_version == 0 ){ echo 'dark_version'; }elseif( $header_version == 1 ){ echo 'light_version'; } ?>">
   <nav class="navbar navbar-default">
       <div class="container-fluid home-v2-pd">
...
if( $catopt == 1 ){
  ...
  if( $inpage_header_layout == 'default' ){
    include( BOUTIQUE_THEMEROOT_DIR .'/template-parts/helper/header-cat2.php');
  }
}
 ?>
