...
class Boutique_Featured_Box extends Widget_Base {
 // Machine name or "handle" for the widget
 public function get_name() {
   return __( 'boutique_featured_box', 'boutique' );
 }
 public function get_title() {
   return __( 'Page Featured box (Black)', 'boutique' );
 }
...
<div class="slider-one-bottom-area">
...
Plugin::instance()->widgets_manager->register_widget_type( new \Elementor\Boutique_Featured_Box() );
