...
function boutique_scripts_and_styles() {
   ...
   */
    ...
    wp_enqueue_style( 'boutique-owl.carousel', get_template_directory_uri() . '/assets/css/owl.carousel.css', array(), '1.3.3', 'all' );
    wp_enqueue_style( 'boutique-owl.theme.css', get_template_directory_uri() . '/assets/css/owl.theme.css', array(), '1.3.3', 'all' );
 ...
 */
    ...
    wp_enqueue_script( 'boutique-slick', get_template_directory_uri() . '/assets/js/slick.min.js', array(), '2.0.4' );
