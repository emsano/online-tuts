            ...
            $parent.append('' +
                '<div class="a13-slider'+slider_classes+'" tabindex="0">' +
					...
					'<div class="slider-controls show-with-slider'/*+(thumb_links? ' with-thumbs' : '')*/+'">' +
						((slides_num > 1)?
							(thumb_links? '<span class="thumb-tray-button fa fa-th'+(thumbs_on_load? ' active' : '')+'" />' : '') +
					...
					((slides_num > 1)?
						(
						'<span class="slider-arrow prev-slide-control  a13icon-chevron-thin-left" />'+
						'<span class="slider-arrow next-slide-control a13icon-chevron-thin-right" />'+
