(function ($) {
    ...
    var PremiumUnfoldHandler = function ($scope, $) {
        ...
        var $unfoldElem = $scope.find(".premium-unfold-wrap"),
            ...
            contentHeight = parseInt($unfoldElem.find(".premium-unfold-editor-content").outerHeight());
    ...
    var PremiumTabsHandler = function ($scope, $) {
        ...
        if ("desktop" !== currentDevice && !settings.carousel_touch) {
