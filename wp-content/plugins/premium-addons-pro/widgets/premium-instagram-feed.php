...
class Premium_Instagram_Feed extends Widget_Base {
    ...
    protected function _register_controls() {
        ...
        $this->add_control('doc_1',
            [
                'type'            => Controls_Manager::RAW_HTML,
                'raw'             => sprintf( __( '%1$s Getting started » %2$s', 'premium-addons-pro' ), '<a href="https://premiumaddons.com/docs/instagram-feed-widget-tutorial/?utm_source=papro-dashboard&utm_medium=papro-editor&utm_campaign=papro-plugin" target="_blank" rel="noopener">', '</a>' ),
        ...
        $this->add_control('doc_2',
            [
                'type'            => Controls_Manager::RAW_HTML,
                'raw'             => sprintf( __( '%1$s How to migrate Instagram Feed widget to the New API » %2$s', 'premium-addons-pro' ), '<a href="https://premiumaddons.com/docs/how-to-migrate-instagram-feed-widget-from-the-old-api-to-the-new-api/?utm_source=papro-dashboard&utm_medium=papro-editor&utm_campaign=papro-plugin" target="_blank" rel="noopener">', '</a>' ),
                'content_classes' => 'editor-pa-doc',
            ]
        );
        ...
        $this->add_control('doc_3',
            [
                'type'            => Controls_Manager::RAW_HTML,
                'raw'             => sprintf( __( '%1$s How to Filter Images By Hashtags » %2$s', 'premium-addons-pro' ), '<a href="https://premiumaddons.com/docs/how-to-filter-images-by-hashtags-in-instagram-feed-widget/?utm_source=papro-dashboard&utm_medium=papro-editor&utm_campaign=papro-plugin" target="_blank" rel="noopener">', '</a>' ),
                'content_classes' => 'editor-pa-doc',
            ]
        );
