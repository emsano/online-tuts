   ...
   public function get_script_depends() {
    ...
    protected function _register_controls() {
       ...
       $repeater->add_control('premium_tabs_content', 
        ...
        $this->add_control('carousel_tabs',
            [
                'label'         => __( 'Enable Carousel Tabs', 'premium-addons-pro' ),
                'type'          => Controls_Manager::SWITCHER,
                'return_value'  => 'true',
                'condition'     => [
        ...
        $this->add_control('carousel_tabs_touch', 
            [
                'label'     => __('Enable On Touch Devices', 'premium-addons-pro'),
                'type'          => Controls_Manager::SWITCHER,
                'return_value'  => 'true',
                'condition'     => [
                    'premium_tab_type'  => 'horizontal',
        ...
        $this->add_control('tabs_notice', 
            [
                'raw'               => __('Please note it\'s recommend to set carousel tabs to an odd value', 'premium-addons-for-elemeentor'),
       ...
       $this->add_control('premium_tab_icon_color',
           [
               ...
               'selectors'     => [
                   ...
                   '{{WRAPPER}} .premium-tab-link svg' => 'fill: {{VALUE}}',
               ],
           ]
       );
       ...
       $this->add_control('premium_tab_hover_icon_color',
           [
               ...
               'selectors'     => [
                   '{{WRAPPER}} .premium-tabs-nav-list-item:hover .premium-title-icon' => 'color: {{VALUE}};',
                   '{{WRAPPER}} .premium-tabs-nav-list-item:hover svg' => 'fill: {{VALUE}}',
               ],
           ]
       );
       ...
       $this->add_control('premium_tab_active_icon_color',
           [
               ...
               'selectors'     => [
                   '{{WRAPPER}} .tab-current .premium-title-icon' => 'color: {{VALUE}}',
                   '{{WRAPPER}} .tab-current .premium-tab-link svg' => 'fill: {{VALUE}}',
               ],
           ]
       );
    ...
    protected function render() {
        ...
        $tabs_settings = [
            ...
            'carousel_touch'=> $settings['carousel_tabs_touch'],
